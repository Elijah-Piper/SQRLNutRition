...
public class UserController {
    ...
    @GetMapping("/checkpassword/{username}/{pw}")
    public boolean checkPassword(@PathVariable String username, @PathVariable String pw) {
        return this.userService.checkPassword(username, pw);
    }
}
